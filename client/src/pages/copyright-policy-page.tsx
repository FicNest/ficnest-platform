    ...
    <div className="container mx-auto px-4 py-8">
      <div className="max-w-4xl mx-auto bg-white rounded-xl shadow-sm p-6 md:p-8">
        ...
        <div className="prose max-w-none">
          <p>We take the intellectual property rights of others seriously and require that our Users do the same. The Digital Millennium Copyright Act (DMCA) established a process for addressing claims of copyright infringement. If you own a copyright or have authority to act on behalf of a copyright owner and want to report a claim that a third party is infringing that material on or through FicNest's services, please submit a DMCA report on our Contact page, and we will take appropriate action.</p>
          ...
          <div className="bg-gray-100 p-6 rounded-lg my-6">
            <p className="font-medium">Your DMCA take down request should be submitted here: <a href="https://ficnest.com/contact" className="text-primary hover:underline">https://ficnest.com/contact</a></p>
            <p className="mt-2">We will then review your DMCA request and take proper actions, including removal of the content from the website.</p>
          </div>
          <h2 className="text-2xl font-semibold mt-8 mb-4">Rapid Response Commitment</h2>
          <ul className="list-disc pl-6 space-y-2">
            <li>We commit to reviewing all DMCA notices within 24 hours</li>
            <li>Content identified in valid notices will be removed immediately</li>
            <li>We maintain records of all takedown requests for legal compliance</li>
          </ul>
        </div>
      </div>
    </div>
