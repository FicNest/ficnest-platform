    ...
    <div className="mb-12">
      ...
      <div className="bg-white p-6 rounded-xl shadow-sm">
        <div className="flex flex-col md:flex-row md:items-center gap-4">
          ...
          <Link to={`/chapters/${readingProgress.chapterId}`}>
...
export default function HomePage() {
  ...
  const { data: featuredNovels, isLoading: isLoadingFeatured } = useQuery<Novel[]>({
    queryKey: ['/api/novels'],
  ...
  return (
    <div className="py-8">
      <div className="container mx-auto px-4">
        ...
        {user && enhancedReadingProgress && (
          <ContinueReading readingProgress={enhancedReadingProgress} />
        )}

        {/* Featured Novels Section */}
        <div className="mb-12">
          <h2 className="text-2xl font-bold mb-6">Featured Novels</h2>
