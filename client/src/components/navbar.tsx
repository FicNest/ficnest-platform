...
import { Menu, X, BookOpen, ChevronDown, LogOut, User, BookmarkIcon, History, BookPlus, PenSquare, Search } from "lucide-react";
...
export default function Navbar() {
  ...
  const [isAuthModalOpen, setIsAuthModalOpen] = useState(false); // Add state for auth modal
  const [authModalTab, setAuthModalTab] = useState("login"); // Track which tab to show
    ...
    <header className="bg-white shadow-sm sticky top-0 z-50">
      ...
      >
        ...
        <div className="flex flex-col space-y-3">
          {user && (
            <>
              <div className="py-2 font-medium text-gray-700">Account</div>
