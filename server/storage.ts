...
export interface IStorage {
  ...
  getNovels(limit: number, offset: number): Promise<Novel[]>;
  ...
  getChapterByNovelAndNumber(novelId: number, chapterNumber: number): Promise<Chapter | undefined>;
  ...
  incrementChapterViews(id: number): Promise<void>;
...
export class DatabaseStorage implements IStorage {
  ...
  async getNovels(limit: number, offset: number): Promise<Novel[]> {
    return db
      .select()
      .from(novels)
  ...
  async getChapterByNovelAndNumber(novelId: number, chapterNumber: number): Promise<Chapter | undefined> {
  ...
  async updateChapter(id: number, updateChapter: Partial<InsertChapter>): Promise<Chapter | undefined> {
    const [chapter] = await db
      .update(chapters)
  ...
  async incrementChapterViews(id: number): Promise<void> {
    // First get the current view count
